...
class Declaration extends Entity
{
    ...
    public function exibeSituacao()
    {
        if ($this->deleted_at != null) {
            if (usuario_logado()->is_cliente) {
                $icone = '<span class="text-danger"><i class="fa fa-circle"></i>&nbsp;Excluído</span>&nbsp;&nbsp;|&nbsp;&nbsp;<i class="fa fa-undo"></i>&nbsp;Desfazer';

                $situacao = anchor("declarations/desfazerExclusaoCliente/$this->id", $icone, ['class' => 'btn btn-outline-succes btn-sm']);

                return $situacao;
            } else {
                $icone = '<span class="text-danger"><i class="fa fa-circle"></i>&nbsp;Excluído</span>&nbsp;&nbsp;|&nbsp;&nbsp;<i class="fa fa-undo"></i>&nbsp;Desfazer';

                $situacao = anchor("declarations/desfazerexclusao/$this->id", $icone, ['class' => 'btn btn-outline-succes btn-sm']);
        ...
        if ($this->status == "ENVIADA") {
            ...
            return '<span class="text-info"><i class="fa fa-circle"></i>&nbsp;Enviada</span>';
        }
