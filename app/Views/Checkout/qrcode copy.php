...
<strong style="color: #A7A7A7"> 2 e 3 de novembro - Centro de Eventos da PUCRS</strong>
                ...
                <div class="card shadow radius-10">
                    <div class="card-body">
                        ...
                        <div class="card-body">
                            ...
                            if ($status == 'RECEIVED') {
                                $url = site_url('checkout/orderbump/' . $transaction->charge_id);
                                header('Location: ' . $url);
                                exit;
...
<div class="fixed-bottom bg-white shadow-lg">
    ...
    <div class="d-grid gap-2 mb-0" style="padding:7px">
        <center><span style="padding-top: 5px; margin-bottom: -5px; font-size: 18px">Esta página será atualizada em </span><strong id="timer" style="font-size: 22px;"></strong></center>
