...
<?php
$total_parcial = $_SESSION['total'] + $_SESSION['valor_frete'];
$desconto = 10;
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        <div class="">
                                            ...
                                            <p class="mb-0 text-muted" style="font-size: 11px">Dreamfest 25 - Mega Convenção Geek</p>
    ...
    $(document).ready(function() {
        ...
        $("#form").on('submit', function(e) {
            ...
            $.ajax({
                ...
                type: 'POST',
                url: '<?php echo site_url('Checkout/finalizarpix'); ?>',
