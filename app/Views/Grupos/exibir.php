...
<div class="row">
    ...
    <div class="col-lg-3">
        ...
        <div class="user-block block">
            ...
            <p class="card-text">Criado <?php echo $grupo->created_at->humanize(); ?></p>
            <p class="card-text">Atualizado <?php echo $grupo->updated_at->humanize(); ?></p>
                ...
                <div class="btn-group mr-2">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <?php else : ?>
                            ...
                            <a class="dropdown-item" href="<?php echo site_url("grupos/desfazerexclusao/$grupo->id"); ?>">Restaurar grupo de
                                acesso</a>
