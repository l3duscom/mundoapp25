            ...
            <div class="block-body">
                <div class="card shadow radius-10">
                    <div class="card-body">
                        ...
                        <!-- Tab links -->
                        <div class="tab">
                            <button class="tablinks" onclick="openCategoria(event, 'sabado')" id="defaultOpen">Basic Sábado<p class="mb-0" style="font-size: 11px">21 de junho</p></button>
                            <button class="tablinks" onclick="openCategoria(event, 'domingo')">Basic Domingo<p class="mb-0" style="font-size: 11px">22 de junho</p></button>
                            <button class="tablinks" onclick="openCategoria(event, 'passaporte')">Basic 2 Dias<p class="mb-0" style="font-size: 11px">21,22 de junho</p></button>
                            <button class="tablinks" onclick="openCategoria(event, 'sabadop')" id="defaultOpen">Premium Sábado<p class="mb-0" style="font-size: 11px">21 de junho</p></button>
                            <button class="tablinks" onclick="openCategoria(event, 'domingop')">Premium Domingo<p class="mb-0" style="font-size: 11px">22 de junho</p></button>
                            <button class="tablinks" onclick="openCategoria(event, 'passaportep')">Premium 2 Dias<p class="mb-0" style="font-size: 11px">21,22 de junho</p></button>
                        ...
                        <div id="sabado" class="tabcontent">
                            ...
                            <p style="padding-top: 20px;">Este ingresso dá direito a participar do Dreamfest 25 - Mega Convenção Geek <strong>somente no sábado </strong>, dia 21/06/2025 das 10h às 19h</p>
                            ...
                            <a href="#" data-bs-toggle="modal" data-bs-target="#comumModal" class="btn btn-outline-secondary w-100 mt-0" style="margin-right: 5px;">O que está incluso nesse ingresso? </a>
                                    ...
                                    <div class="card border border-muted">
                                        <div class="form-check mt-3 mb-3">
                                            <div class="row">
                                                ...
                                                <div class="col-11">
                                                    <a class="btn btn-sm btn-outline-secondary w-100 mt-1" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="true" aria-controls="collapseExample">
                                                        Este ingresso serve para quem?
                                                    </a>
                                                    <div class="collapse show" id="collapseExample">
                                                        <div class="card card-body">
                                                            <div class="text-muted"><?= $value['descricao'] ?></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <div id="domingo" class="tabcontent">
                            <p style="padding-top: 20px;">Este ingresso dá direito a participar do Dreamfest 25 - Mega Convenção Geek <strong>somente no domingo </strong>, dia 22/06/2025 das 10h às 19h</p>
                            <p>Você receberá uma credencial exclusiva e colecionável que deverá ser apresentada na entrada e na saída do festival e sempre que for requisitada. Você terá direito à entrar e sair do evento sempre que quiser!</p>
                            <a href="#" data-bs-toggle="modal" data-bs-target="#comumModal" class="btn btn-outline-secondary w-100 mt-0" style="margin-right: 5px;">O que está incluso nesse ingresso? </a>
                                    ...
                                    <div class="card border border-muted">
                                        <div class="form-check mt-3 mb-3">
                                            <div class="row">
                                                ...
                                                <div class="col-11">
                                                    <a class="btn btn-sm btn-outline-secondary w-100 mt-1" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">
                                                        Este ingresso serve para quem?
                                                    </a>
                                                    <div class="collapse show" id="collapseExample">
                                                        <div class="card card-body">
                        ...
                        <div id="passaporte" class="tabcontent">
                            ...
                            <p style="padding-top: 20px;">Este ingresso dá direito a participar do Dreamfest 25 - Mega Convenção Geek <strong>nos dois dias de evento</strong>, das 10h às 19h</p>
                            <p>Você receberá uma credencial exclusiva e colecionável que deverá ser apresentada na entrada e na saída do festival e sempre que for requisitada. Você terá direito à entrar e sair do evento sempre que quiser!</p>
                            <a href="#" data-bs-toggle="modal" data-bs-target="#comumModal" class="btn btn-outline-secondary w-100 mt-0" style="margin-right: 5px;">O que está incluso nesse ingresso? </a>
                        ...
                        <div id="sabadop" class="tabcontent">

                            <p style="padding-top: 20px;">Este ingresso dá direito a participar do Dreamfest 25 - Mega Convenção Geek <strong>somente no sábado </strong>, dia 21/06/2025 das 10h às 19h</p>
                            <p>Você receberá uma credencial exclusiva e colecionável que deverá ser apresentada na entrada e na saída do festival e sempre que for requisitada. Você terá direito à entrar e sair do evento sempre que quiser!</p>
                            <a href="#" data-bs-toggle="modal" data-bs-target="#premiumModal" class="btn btn-outline-secondary w-100 mt-0" style="margin-right: 5px;">O que está incluso nesse ingresso? </a>
                            ...
                            <?php foreach ($items as $key => $value) : ?>
                                <?php if ($value['categoria'] == 'premium' && $value['tipo'] == 'individual' && $value['dia'] == 'sab') : ?>
                                    <div class="card border border-muted">
                                        <div class="form-check mt-3 mb-3">
                                            <div class="row">
                                                <div class="col-7">
                        ...
                        <div id="domingop" class="tabcontent">
                            <p style="padding-top: 20px;">Este ingresso dá direito a participar do Dreamfest 25 - Mega Convenção Geek <strong>somente no domingo </strong>, dia 22/06/2025 das 10h às 19h</p>
                            <p>Você receberá uma credencial exclusiva e colecionável que deverá ser apresentada na entrada e na saída do festival e sempre que for requisitada. Você terá direito à entrar e sair do evento sempre que quiser!</p>
                            <a href="#" data-bs-toggle="modal" data-bs-target="#premiumModal" class="btn btn-outline-secondary w-100 mt-0" style="margin-right: 5px;">O que está incluso nesse ingresso? </a>
                            ...
                            <?php foreach ($items as $key => $value) : ?>
                                <?php if ($value['categoria'] == 'premium' && $value['tipo'] == 'individual' && $value['dia'] == 'dom') : ?>
                                    <div class="card border border-muted">
                                        <div class="form-check mt-3 mb-3">
                                            <div class="row">
                                                <div class="col-7">
                        ...
                        <div id="passaportep" class="tabcontent">
                            ...
                            <?php foreach ($items as $key => $value) : ?>
                                <?php if ($value['categoria'] == 'premium' && $value['tipo'] == 'combo') : ?>
                                    <div class="card border border-muted">
                                        <div class="form-check mt-3 mb-3">
                                            <div class="row">
                                                <div class="col-7">
                    ...
                    <?php if ($_SESSION['total'] != 0) : ?>
                        <div class="card card-body" id="pagar">
