...
if (isset($_GET['convite']) && isset($_SESSION['convite'])) {
...
$access_token = "APP_USR-4187391579192936-010717-adebfeb2caf9a655d56a325e444ab651-613926042";
...
$item->title = 'Ingressos Dreamfest';
$item->quantity = 1;
$item->unit_price = (float)$_SESSION['total'];
$preference->items = array($item);

$preference->back_urls = array(
    "success" => 'https://mundodream.com.br/checkout/success',
    "failure" => 'https://mundodream.com.br/checkout/failure',
    "pending" => 'https://mundodream.com.br/checkout/pending'
);

$preference->notification_url = 'https://mundodream.com.br/cronml.php';
$preference->external_reference = 'codigoproduto';
$preference->save();
                ...
                <div class="card shadow radius-10">
                    <div class="card-body">
                        ...
                        $items = array(
                            ...
                            ['tipo' => 'individual', 'modal' => 'comum', 'imagem' => 'recursos/front/images/ingressos/individual-35-sabado.png', 'nome' => 'Ingresso Comum SÁBADO - Meia e meia solidária | Lote 1', 'preco' => '5.00'],
                                ...
                                <div class="card-body shadow">
                                    <div class="d-flex align-items-center ">
                                        <div class="">
                                            ...
                                            <p class="mb-0 text-muted" style="font-size: 14px">Monte seu passaporte para a diversão!</p>
                                        </div>
                    ...
                    -->
                                ...
                                <div class="card-body shadow">
                                    <div class="d-flex align-items-center ">
                                        <div class="">
                                            ...
                                            <p class="mb-0 text-muted" style="font-size: 14px">Aqui você encontra o resumo dos ingressos que você escolheu!</p>
                                        </div>
                        ...
                        <div id="areaBotoes" class="row g-3">
                            <div class="col-12">
                                <a href="<?= $link; ?>" class="w-100 btn btn-primary btn-lg btn-block "> Ir para pagamento</a>
                        ...
                        <hr>
                        <center>
                            <span class="text-muted" style="font-size:10px">by </span><img src="<?php echo site_url('/recursos/front/images/ingressos/mercado-pago-logo.png'); ?>" height="40px" width="auto">
                        </center>
                    </div>
                </div>
            </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <iframe width="100%" height="600px" frameborder="0" marginheight="0" marginwidth="0" src="<?= $link; ?>">
                </iframe>
