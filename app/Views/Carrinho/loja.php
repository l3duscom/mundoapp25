...
<h5 class="mb-0 mt-3">LOJA OFICIAL DO DREAM!</h5>
            ...
            <div class="block-body">
                <div class="card shadow radius-10">
                    <div class="card-body">
                        ...
                        <?php
                        $items = array(
                            //['categoria' => 'sab', 'data' => '09/12/2023', 'lote' => 'único', 'nome_exibicao' => 'Copo colecionável', 'tipo_exibicao' => 'exclusivo', 'tipo' => 'produto', 'modal' => '#', 'descricao' => 'Copo colecionável exclusivo Dreamfest - Mega Festival Geek 23 Parte 2', 'nome' => 'Copo Colecionável | DF23/2', 'preco' => '24.49', 'taxa' => '0'],
                            ['categoria' => 'sab', 'data' => '09/12/2023', 'lote' => 'único', 'nome_exibicao' => 'Pôster colecionável', 'tipo_exibicao' => 'exclusivo', 'tipo' => 'produto', 'modal' => '#', 'descricao' => 'Pôster colecionável exclusivo Dreamfest - Mega Festival Geek 23 Parte 2', 'nome' => 'Pôster Colecionável | DF23/2', 'preco' => '14.49', 'taxa' => '0'],
                            // ['categoria' => 'sab', 'data' => '09/12/2023', 'lote' => 'único', 'nome_exibicao' => 'Combo Copo + Pôster colecionável', 'tipo_exibicao' => 'exclusivo', 'tipo' => 'produto', 'modal' => '#', 'descricao' => 'Combo Copo + Pôster colecionável exclusivo Dreamfest - Mega Festival Geek 23 Parte 2', 'nome' => 'Combo Copo + Pôster Colecionável | DF23/2', 'preco' => '29.49', 'taxa' => '0'],
                        ...
                        <div class="row" style="padding: 10px; ">
                            ...
                            <!-- Tab links -->
                            <div class="tab">
                                <button class="tablinks" onclick="openCategoria(event, 'sabado')" id="defaultOpen">Colecionáveis<p class="mb-0" style="font-size: 11px">DF 23 parte 2</p></button>
                        ...
                        <div id="resumo" style="padding: 5px;">
                            <?php if (isset($_SESSION['carrinho'])) : ?>
                                <table class="table mb-0 table-hover">
                                    ...
                                    <?php else : ?>
                                        <center>
                                            <i class="fadeIn animated bx bx-error-circle"></i><br>Oooops, seu carrinho está vazio, escolha um colecionável exclusivo!
                                            <hr>
                                            <button type="button" class="btn btn-primary" data-bs-dismiss="modal">Adicionar produtos</button>
                                            <hr>
                                        </center>
                                        </hr>
                                    <?php endif; ?>
                        ...
                        <div class="card-body shadow">
                            <div class="d-flex align-items-center ">
                                <div class="">
                                    ...
                                    <p class="mb-0 text-muted" style="font-size: 14px">Aqui você encontra o resumo dos produtors que <strong style="color:blueviolet"><?= $influencer ?></strong> te ajudou a escolher!</p>
                                </div>
