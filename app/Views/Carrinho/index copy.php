            ...
            <div class="block-body">
                <div class="card shadow radius-10">
                    <div class="card-body">
                        ...
                        <!-- Tab links -->
                        <div class="tab">
                            <button class="tablinks" onclick="openCategoria(event, 'sabado')" id="defaultOpen">Sábado<p class="mb-0" style="font-size: 11px">21 de junho</p></button>
                            <button class="tablinks" onclick="openCategoria(event, 'domingo')">Domingo<p class="mb-0" style="font-size: 11px">22 de junho</p></button>
                            <button class="tablinks" onclick="openCategoria(event, 'passaporte')">2 Dias<p class="mb-0" style="font-size: 11px">21,22 de junho</p></button>
                    ...
                    <?php if ($_SESSION['total'] != 0) : ?>
                        <div class="fixed-bottom bg-white" style="box-shadow: 0px 0px 30px 0px rgba(0, 0, 0, 0.2);border-top: 9px solid purple;">
                            ...
                            <div class="d-grid gap-2 mb-0" style="padding:10px">
                                ...
                                <a class="btn btn-light shadow" style="border-color: #333333;" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="true" aria-controls="collapseExample">
                                    <!-- <i class="bi bi-arrow-down-circle-fill" style="font-size: 25px; color: purple;"></i>-->
                                    <i class='bx bx-down-arrow-circle'></i> Continuar compando
                                </a>
