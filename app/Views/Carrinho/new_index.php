                ...
                <div class="card shadow radius-10">
                    <div class="card-body">
                        ...
                        $items = array(
                            ...
                            ['modal' => 'comum', 'imagem' => 'recursos/front/images/ingressos/individual-35.png', 'nome' => 'Ingresso Comum DOMINGO - Meia e meia solidária', 'preco' => '35.00'],
                            ['modal' => 'puc', 'imagem' => 'recursos/front/images/ingressos/individual-35-puc.png', 'nome' => 'Ingresso Comum DOMINGO - PUCRS', 'preco' => '35.00'],
                            ['modal' => 'vip-fan', 'imagem' => 'recursos/front/images/ingressos/vip-fan.png', 'nome' => 'Ingresso VIP FAN', 'preco' => '115.00'],
                            ['modal' => 'vip-full', 'imagem' => 'recursos/front/images/ingressos/vip-full.png', 'nome' => 'Ingresso VIP FULL', 'preco' => '195.00'],
                            ['modal' => 'clube', 'imagem' => 'recursos/front/images/ingressos/clube.png', 'nome' => 'DreamClub', 'preco' => '85.00'],
                            ['modal' => 'inteira', 'imagem' => 'recursos/front/images/ingressos/individual-70.png', 'nome' => 'Ingresso Comum DOMINGO', 'preco' => '70.00'],
                        ...
                        <div class="row">
                            <img src="<?php echo site_url('recursos/front/images/ingressos/header.png'); ?>" alt="" width="100%" height="auto">
                            <hr>
                        </div>
                        ...
                        <div class=" mt-1"></div>
                        <div class="row">
                            <img src="<?php echo site_url('recursos/front/images/ingressos/sacola.png'); ?>" alt="" width="100%" height="auto">
                            <hr>
                        </div>
                        ...
                        <center>
                            <p class="text-muted mb-2 mt-4" style="font-size: 10px; margin-bottom: -1px">Pagamento processado por:</p>
...
<div class="fixed-bottom bg-white shadow-lg">
    ...
    <div class="row row-cols-1 row-cols-lg-4 row-cols-xl-12 mb-3 mt-3 " style="padding-left: 20px; padding-right:20px">
        <div class="col-lg-4 col-xl-4 col-sm-12 col-xs-12">
            ...
            <div class="">
                ...
                <div class="d-flex align-items-center">
                    <div class="">
                        ...
                        <h3 class="mb-0 font-24"><strong>R$ <?= $_SESSION['total'] ?></strong></h3>
                    </div>
                    <div class="ms-auto mr-3">
                        <p style="font-size: 10px;margin-bottom: -1px;">pagar com:</p>
                        <a href="<?= site_url('/checkout/cartao') ?>" class="w-100 btn btn-primary btn-lg "> Cartão</a>
                    </div>
                    <div class="ms-auto  mb-0">
                        <p style="font-size: 10px;margin-bottom: -1px;">pagar com:</p>
                        <a href="<?= site_url('/checkout/pix') ?>" class="w-100 btn btn-primary btn-lg  "> Pix / Boleto</a>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <table class="table mb-0 table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row">Acesso à Spoiler Night (sábado) das 20 às 22</th>
                                    <td style="color:green; font-size: 22px"><i class="fadeIn animated bx bx-check-circle"></i></td>
                                </tr>
                                <tr>
                ...
                <div class="card">
                    <div class="card-body">
                        <table class="table mb-0 table-hover">
                            ...
                            <tbody>
                                <small class="text-muted">** Espaços disponíveis apenas no domingo.<br>**** Mediante disponibilidade do convidado. Não inclui convidado internacional.</small>
                                <tr>
                                    <th scope="row">Fila preferencial (Entrada e Food Park)</th>
                                    <td style="color:green; font-size: 22px"><i class="fadeIn animated bx bx-check-circle"></i></td>
                                </tr>
                                <tr>
                                    <th scope="row">Acesso ao evento (domingo) das 9 às 20</th>
                                    <td style="color:green; font-size: 22px"><i class="fadeIn animated bx bx-check-circle"></i></td>
                                </tr>
                                <tr>
                                    <th scope="row">Acesso à Spoiler Night (sábado) das 20 às 22</th>
