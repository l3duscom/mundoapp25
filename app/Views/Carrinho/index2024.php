            ...
            <div class="block-body">
                <div class="card shadow radius-10">
                            ...
                            if (isset($items[$idProduto])) {
                                ...
                                if (isset($_SESSION['carrinho'][$idProduto])) {
                                    ...
                                    $_SESSION['carrinho'][$idProduto] = array(
                                        'quantidade' => 1,
                                        'nome' => $produto['nome'],
                                        'preco' => $produto['preco'] + ($produto['preco'] * 0.15),
                                        'tipo' => $produto['tipo'],
                                        'taxa' => $produto['preco'] * 0.15,
                            ...
                            <div class="col-lg-6">
                                <div class="card border border-muted">
                                    <div class="form-check mt-3">
                                        <div class="row">
                                            <div class="col-8 ">
                                                <strong class="font-20">Comum Sábado</strong><br>
                                                <span class="text-muted">1 dia - <strong>2º lote</strong></span>
                                            </div>
                                            <div class="col-4">
                                                <span class="text-muted" style="font-size: 10px;">A partir de:</span><br>

                                                <span class="font-12">R$</span><span class="font-24" style="color: #333"><strong> 44,49</strong></span>
                                    ...
                                    <div class="btn-group mb-2" style="padding-top: 12px;padding-left: 12px;padding-right: 12px;margin-top: -10px;">
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#comumModal" class="btn btn-outline-secondary w-100 mt-0" style="margin-right: 5px;">O que está incluso?</a>

                                        <a href="#" data-bs-toggle="modal" data-bs-target="#ingIndividualSabModal" class="btn w-100 mt-0 " style="background-color: #ffcc00; color: #333; font-weight:bold;margin-left: 5px;">Selecionar tipo <i class="bi bi-caret-down-fill"></i></a>
                                    </div>
                                    <span class="text-muted" style="font-size: 11px; padding-right:17px; text-align: right;"><strong>Tipos disponíveis: </strong>Meia-Entrada, Solidário, Inteiro</span><br>
                            ...
                            <div class="col-lg-6">
                                <div class="card border border-muted">
                                    <div class="form-check mt-3">
                                        <div class="row">
                                            <div class="col-8 ">
                                                <strong class="font-20">Comum Domingo</strong><br>
                                                <span class="text-muted">1 dia - <strong>2º lote</strong></span>
                                            </div>
                                            <div class="col-4">
                                                <span class="text-muted" style="font-size: 10px;">A partir de:</span><br>

                                                <span class="font-12">R$</span><span class="font-24" style="color: #333"><strong> 42,49</strong></span>
                                    ...
                                    <div class="btn-group mb-2" style="padding-top: 12px;padding-left: 12px;padding-right: 12px;margin-top: -10px;">
                                        ...
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#ingIndividualDomModal" class="btn w-100 mt-0 " style="background-color: #ffcc00; color: #333; font-weight:bold;margin-left: 5px;">Selecionar tipo <i class="bi bi-caret-down-fill"></i></a>
                                    </div>
                                    <span class="text-muted" style="font-size: 11px; padding-right:17px; text-align: right;"><strong>Tipos disponíveis: </strong>Meia-Entrada, Solidário, Inteiro</span><br>
                            ...
                            <div class="col-lg-6">
                                <div class="card border border-muted">
                                    <div class="form-check mt-3">
                                        <div class="row">
                                            <div class="col-8 ">
                                                <strong class="font-20">Passaporte</strong><br>
                                                <span class="text-muted">2 dias - <strong>2º lote</strong></span>
                                            </div>
                                            <div class="col-4">
                                                <span class="text-muted" style="font-size: 10px;">A partir de:</span><br>

                                                <span class="font-12">R$</span><span class="font-24" style="color: #333"><strong> 81,49</strong></span>
                                    ...
                                    <div class="btn-group mb-2" style="padding-top: 12px;padding-left: 12px;padding-right: 12px;margin-top: -10px;">
                                        ...
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#ingComboModal" class="btn w-100 mt-0 " style="background-color: #ffcc00; color: #333; font-weight:bold;margin-left: 5px;">Selecionar tipo <i class="bi bi-caret-down-fill"></i></a>
                                    </div>
                                    <span class="text-muted" style="font-size: 11px; padding-right:17px; text-align: right;"><strong>Tipos disponíveis: </strong>Meia-Entrada, Solidário, Inteiro</span><br>
                            ...
                            <div class="col-lg-6">
                                <div class="card border border-muted">
                                    <div class="form-check mt-3">
                                        <div class="row">
                                            <div class="col-8 ">
                                                <strong class="font-20">EPIC PASS</strong><br>
                                                <span class="text-muted">Experiência Épica - <strong>2º lote</strong></span>
                                            </div>
                                            <div class="col-4">
                                                <span class="text-muted" style="font-size: 10px;">A partir de:</span><br>

                                                <span class="font-12">R$</span><span class="font-24" style="color: #333"><strong> 99,49</strong></span>
                                    ...
                                    <div class="btn-group mb-2" style="padding-top: 12px;padding-left: 12px;padding-right: 12px;margin-top: -10px;">
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#vip-fanModal" class="btn btn-outline-secondary w-100 mt-0" style="margin-right: 5px;">O que está incluso?</a>

                                        <a href="#" data-bs-toggle="modal" data-bs-target="#ingEpicModal" class="btn w-100 mt-0 " style="background-color: #ffcc00; color: #333; font-weight:bold;margin-left: 5px;">Selecionar tipo <i class="bi bi-caret-down-fill"></i></a>
                                    </div>
                                    <span class="text-muted" style="font-size: 11px; padding-right:17px; text-align: right;"><strong>Tipos disponíveis: </strong>Meia-Entrada, Solidário, Inteiro</span><br>
                            ...
                            <div class="col-lg-6">
                                <div class="card border border-muted">
                                    <div class="form-check mt-3">
                                        <div class="row">
                                            <div class="col-8 ">
                                                <strong class="font-20">VIP FULL</strong><br>
                                                <span class="text-muted">Experiência Máxima - <strong>2º lote</strong></span>
                                            </div>
                                            <div class="col-4">
                                                <span class="text-muted" style="font-size: 10px;">A partir de:</span><br>

                                                <span class="font-12">R$</span><span class="font-24" style="color: #333"><strong> 237,37</strong></span>
                                    ...
                                    <div class="btn-group mb-2" style="padding-top: 12px;padding-left: 12px;padding-right: 12px;margin-top: -10px;">
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#vip-fullModal" class="btn btn-outline-secondary w-100 mt-0" style="margin-right: 5px;">O que está incluso?</a>

                                        <a href="#" data-bs-toggle="modal" data-bs-target="#ingVipModal" class="btn w-100 mt-0 " style="background-color: #ffcc00; color: #333; font-weight:bold;margin-left: 5px;">Selecionar tipo <i class="bi bi-caret-down-fill"></i></a>
                                    </div>
                                    <span class="text-muted" style="font-size: 11px; padding-right:17px; text-align: right;"><strong>Tipos disponíveis: </strong>Meia-Entrada, Solidário, Inteiro</span><br>
                            ...
                            <div class="col-lg-6">
                                <div class="card border border-muted">
                                    <div class="form-check mt-3">
                                        <div class="row">
                                            <div class="col-8 ">
                                                <strong class="font-20">Cosplayer paga meia</strong><br>
                                                <span class="text-muted">Promocional</span>
                                            </div>
                                            <div class="col-4">
                                                <span class="text-muted" style="font-size: 10px;">A partir de:</span><br>
                                    ...
                                    <div class="btn-group mb-2" style="padding-top: 12px;padding-left: 12px;padding-right: 12px;margin-top: -10px;">
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#cosplayerModal" class="btn btn-outline-secondary w-100 mt-0" style="margin-right: 5px;">O que está incluso?</a>

                                        <a href="#" data-bs-toggle="modal" data-bs-target="#ingCosplayModal" class="btn w-100 mt-0 " style="background-color: #ffcc00; color: #333; font-weight:bold;margin-left: 5px;">Selecionar tipo <i class="bi bi-caret-down-fill"></i></a>
                                    </div>
                                    <span class="text-muted" style="font-size: 11px; padding-right:17px; text-align: right;"><strong>Tipos disponíveis: </strong>Meia-Entrada, Solidário, Inteiro</span><br>
                    ...
                    <?php if ($_SESSION['total'] != 0) : ?>
                        <div class="fixed-bottom bg-white" style="box-shadow: 0px 0px 30px 0px rgba(0, 0, 0, 0.2);border-top: 9px solid purple;">


                            <div id="resumo" style="padding-right: 25px; padding-left: 25px; ">


                                <div class="text-center">
                                    <a class="btn btn-light btn-lg" style="border-color: #FFFFFF;" data-bs-toggle="collapse" href="#collapseExample" role="button" aria-expanded="true" aria-controls="collapseExample">
                                        <i class="bi bi-arrow-down-circle-fill" style="font-size: 25px; color: purple;"></i>
                                    </a>
                                </div>

                                <div class="collapse show mb-0 mt-0" id="collapseExample">
                                                    ...
                                                    <?php foreach ($_SESSION['carrinho'] as $key => $value) : ?>
                                                        <?php if ($value['quantidade'] != 0) : ?>
                                                            <tr>
                                                                ...
                                                                <td>R$ <strong><?= number_format($value['quantidade'] * $value['unitario'], 2, ',', ''); ?></strong><span style="font-size: 12px;"> + R$ <?= number_format($value['quantidade'] * $value['taxa'], 2, ',', ''); ?> taxa de ingresso</span> </td>
                                                            </tr>
                                                        <?php endif; ?>
                                                        <?php
                            ...
                            <div class="d-grid gap-2 mb-0" style="padding:10px">
                                ...
                                <a href="<?= site_url('/evento/entrega') ?>" class="btn btn-lg mt-0" style="padding:10px; background-color: purple; border-color: purple; color: white;">Continuar</a>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="">
                        ...
                        <p class="mb-0 text-muted" style="font-size: 11px"><strong>#VivaSeuSonho</strong></p>
                    </div>
                    <div class="ms-auto fs-3 mb-0 text-muted">

                    </div>

                    <div class="ms-auto fs-3 mt-2">
                        <p class="mb-0" style="font-size: 10px;">Total a pagar:</p>
                        <strong style="font-size: 14px;  margin-top: -30px">R$ </strong><strong style="font-size: 23px;"><?= number_format($_SESSION['total'], 2, ',', '') ?></strong>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <?php foreach ($items as $key => $value) : ?>
                            <?php if ($value['categoria'] == 'comum' && $value['tipo'] == 'individual' && $value['dia'] == 'sab') : ?>
                                <div class="card border border-muted">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="max-height: 500px; overflow-y: auto;">
                ...
                <div class="card">
                    <div class="card-body">
                        <?php foreach ($items as $key => $value) : ?>
                            <?php if ($value['categoria'] == 'comum' && $value['tipo'] == 'individual' && $value['dia'] == 'dom') : ?>
                                <div class="card border border-muted">
                                    <div class="form-check mt-3 mb-3">
                                        <div class="row ">
                                            <div class="col-6 mb-2">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="max-height: 500px; overflow-y: auto;">
                ...
                <div class="card">
                    <div class="card-body">
                        <?php foreach ($items as $key => $value) : ?>
                            <?php if ($value['categoria'] == 'comum' && $value['tipo'] == 'combo') : ?>
                                <div class="card border border-muted">
                                    <div class="form-check mt-3 mb-3">
                                        <div class="row ">
                                            <div class="col-6 mb-2">
