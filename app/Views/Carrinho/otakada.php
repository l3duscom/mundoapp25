                            ...
                            <div class="col-lg-6">
                                <div class="card border border-muted">
                                    <div class="form-check mt-3">
                                        <div class="row">
                                            <div class="col-8 ">
                                                <strong class="font-20">Individual</strong><br>
                                                <span class="text-muted">1 dia </span>
                                            </div>
                                            <div class="col-4">
                                    ...
                                    <div class="btn-group mb-2" style="padding: 12px;margin-top: -10px;">

                                        <a href="#" data-bs-toggle="modal" data-bs-target="#ingIndividualModal" class="btn w-100 mt-0 " style="background-color: #ffcc00; color: #333; font-weight:bold;margin-left: 5px;">Quero este!</a>
                                    </div>
                            ...
                            <div class="col-lg-6">
                                <div class="card border border-muted">
                                    <div class="form-check mt-3">
                                        <div class="row">
                                            <div class="col-8 ">
                                                ...
                                                <span class="text-muted">2 dias </span>
                                            </div>
                                            <div class="col-4">
                                    ...
                                    <div class="btn-group mb-2" style="padding: 12px;margin-top: -10px;">
                                        ...
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#ingComboModal" class="btn w-100 mt-0 " style="background-color: #ffcc00; color: #333; font-weight:bold;margin-left: 5px;">Quero este!</a>
                                    </div>
                            ...
                            <div class="col-lg-6">
                                <div class="card border border-muted">
                                    <div class="form-check mt-3">
                                        <div class="row">
                                            <div class="col-8 ">
                                                ...
                                                <span class="text-muted">Experiência Épica </span>
                                            </div>
                                            <div class="col-4">
                                    ...
                                    <div class="btn-group mb-2" style="padding: 12px;margin-top: -10px;">
                                        ...
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#ingEpicModal" class="btn w-100 mt-0 " style="background-color: #ffcc00; color: #333; font-weight:bold;margin-left: 5px;">Quero este!</a>
                                    </div>
                            ...
                            <div class="col-lg-6">
                                <div class="card border border-muted">
                                    <div class="form-check mt-3">
                                        <div class="row">
                                            <div class="col-8 ">
                                                ...
                                                <span class="text-muted">Experiência Máxima</span>
                                            </div>
                                            <div class="col-4">
                                    ...
                                    <div class="btn-group mb-2" style="padding: 12px;margin-top: -10px;">
                                        ...
                                        <a href="#" data-bs-toggle="modal" data-bs-target="#ingVipModal" class="btn w-100 mt-0 " style="background-color: #ffcc00; color: #333; font-weight:bold;margin-left: 5px;">Quero este!</a>
                                    </div>
...
<div class="modal fade" id="ingIndividualModal" tabindex="-1" aria-labelledby="ingIndividualModal" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="ingIndividualModal">Escolha uma opção:</h5>
                ...
                <div class="card">
                    <div class="card-body">
                        <?php foreach ($items as $key => $value) : ?>
                            <?php if ($value['categoria'] == 'comum' && $value['tipo'] == 'individual') : ?>
                                <div class="card border border-muted">
