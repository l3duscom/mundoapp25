...
<h5 class="mb-0 mt-3">Vamos melhorar a sua experiência?</h5>
            ...
            <div class="block-body">
                <div class="card shadow radius-10">
                    <div class="card-body">
                        ...
                        <!-- Tab links -->
                        <div class="tab">
                            <button class="tablinks" onclick="openCategoria(event, 'fastpass')" id="defaultOpen">Fast Pass<p class="mb-0" style="font-size: 11px">Fura fila</p></button>
                        ...
                        <!-- Tab content -->
                        <div id="fastpass" class="tabcontent">
                            ...
                            <hr>
                            <div class="mb-0 mt-3 font-24" style="color: #333;">Selecione seu upgrade </div>
