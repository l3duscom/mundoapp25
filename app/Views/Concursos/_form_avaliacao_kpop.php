<div class="row">
    ...
    <div class="col-lg-3">
        <div class="block text-center">
            ...
            <strong>Sincronia e formação (somente grupo)</strong>
            <hr>
            <select id="nota_2" name="nota_2" class="form-control form-control-lg text-center" style="font-size: 38px; height: 100px">
                <option value="0">--</option>
                <option value="10">10</option>
                <option value="9.5">9.5</option>
                <option value="9">9</option>
