...
<p>Sua inscrição <?= $inscricao->codigo ?> para o <?= $concurso->nome ?> foi aprovada \0/</p>
...
<hr>
<p><strong>Acesse:</strong><a href="https://ingressos.dreamfest.com.br"> sua área de membros</a> com o email <?= $cliente->email ?> para fazer checkin e confirmar sua inscrição!</p>
<hr>
