...
<div class="row">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3"></strong></div>
        <?php if ($inscricao->integrantes == 1) : ?>
            <h3>Avaliação de <?= $inscricao->nome_social ?></h3>
        <?php else : ?>
            <h3>Avaliação do grupo <?= $inscricao->grupo ?></h3>
        <?php endif; ?>
    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-8">
                                    ...
                                    <?php if ($inscricao->integrantes == 1) : ?>
                                        <?php echo $this->include('Concursos/_form_avaliacao_ksolo'); ?>
                                    <?php else : ?>
                                        <?php echo $this->include('Concursos/_form_avaliacao_kgrupo'); ?>
                                    <?php endif; ?>
