    ...
    <div class="col-lg-12">
        <div class="card shadow radius-10">
            <div class="card-body">
                ...
                <?php echo form_open_multipart('Concursos/atualizar_inscricao_kpop', ['id' => 'form-edicao']) ?>
                ...
                <div class="alert alert-info fade show" role="alert">
                    ...
                    <strong>Importante:</strong> Ao salvar as alterações, o status da sua inscrição será alterado para "Inscrição Editada" e passará por uma nova avaliação. Os arquivos são opcionais - só envie novos arquivos se desejar substituir os atuais.
                </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        <label class="form-control-label text-muted">Vídeo de Apresentação</label>
                        <input type="text" name="video_apresentacao" value="<?= esc($inscricao->video_apresentacao) ?>" placeholder="https://" class="form-control mb-2 shadow" style="padding:13px;" required>
                    </div>
                    <div class="form-group col-md-4">
                        <label class="form-control-label">Nome do Grupo/Dupla</label>
                        <input type="text" name="grupo" value="<?= esc($inscricao->grupo) ?>" class="form-control mb-2 shadow" style="padding:13px;">
                    </div>
                    <div class="form-group col-md-4">
                        <label class="form-control-label">Integrantes</label>
                        <input type="number" name="integrantes" value="<?= esc($inscricao->integrantes) ?>" class="form-control mb-2 shadow" style="padding:13px;">
                    </div>
                    <div class="form-group col-md-4">
                        <label class="form-control-label">Categoria</label>
                        <select name="categoria" class="form-control mb-2 shadow" required>
                            <option value="grupo" <?= $inscricao->categoria == 'grupo' ? 'selected' : '' ?>>Grupo</option>
                            <option value="dupla" <?= $inscricao->categoria == 'dupla' ? 'selected' : '' ?>>Dupla</option>
                            <option value="solo" <?= $inscricao->categoria == 'solo' ? 'selected' : '' ?>>Solo</option>
                        </select>
                    </div>
                    ...
                    <div class="col-12 mt-3">
                        <div class="card shadow radius-10">
                            <div class="card-body">
                                <span style="font-weight: 600; font-size:16px">Arquivos (opcional - envie apenas se desejar substituir)</span>
                                <hr>
                                
                                <!-- Alerta de validação de arquivos -->
                                ...
                                <div class="form-group col-md-12 mb-3">
                                    ...
                                    <input type="text" name="nome_musica" value="<?= esc($inscricao->nome_musica ?? '') ?>" class="form-control" placeholder="Ex: Dynamite - BTS" required>
                                    <small class="text-muted">Informe o nome da música e artista que será usada na apresentação.</small>
                                </div>
                                <div class="form-group col-md-12 mb-3">
                                    <label class="form-control-label">Música atual:</label>
                                    <a href="<?= site_url("concursos/imagem/{$inscricao->musica}") ?>" target="_blank" class="btn btn-sm btn-outline-primary">Ouvir</a>
                                    <input type="file" name="musica" class="form-control mt-2" accept=".mp3">
                                    <small class="text-muted">Formato: MP3. Máx. 50MB</small>
                                </div>
                                <div class="form-group col-md-12 mb-3">
