    ...
    <div class="col-lg-4">
        ...
        <div class="user-block block">
            ...
            <?php if ($cliente->grupo_id == 3) : ?>
                <h5 class="card-title mt-2"><i class="lni lni-crown" style="color: #ffd700"></i> <?php echo esc($cliente->nome); ?></h5>
            <?php else : ?>
            ...
            <p class="card-text">Criado <?php echo $cliente->created_at->humanize(); ?></p>
            <p class="card-text">Atualizado <?php echo $cliente->updated_at->humanize(); ?></p>
