<p>Saudações,</p>
<p>Sua conta no Mundo Dream foi criada com sucesso e você já pode desfrutar de tudo o que temos a te oferecer!
</p>
<p>Seja muito bem vindo(a), seus dados de acesso são:</p>

<p>E-mail de acesso: <?php echo esc($cliente->email); ?></p>

<p><strong>Crie sua senha <a href="<?php echo site_url("esqueci"); ?>"><strong>agora mesmo</strong></a></strong> e viva a magia!</p>
