...
<div class="row">
    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Inserir endereço de entrega</div>
    </div>
    <!--end breadcrumb-->
            ...
            <div class="block-body">
                ...
                <div class="card shadow bg-dark radius-10">
                    <div class="card-body">
                        ...
                        <?php echo $this->include('Pedidos/_form_cartao'); ?>
    ...
    $(document).ready(function() {
        ...
        $("#form").on('submit', function(e) {
            ...
            $.ajax({
                ...
                type: 'POST',
                url: '<?php echo site_url('pedidos/registrar_endereco_cartao'); ?>',
                    ...
                    if (!response.erro) {
                        ...
                        if (response.info) {
                            ...
                            window.location.href =
                                "<?php echo site_url("ingressos/"); ?>" + response.id;
