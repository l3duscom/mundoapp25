    ...
    <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
        ...
        <div class="ms-auto">
            <div class="btn-group" style="padding-right: 30px;">
                <a href="<?= site_url('/ingressos/gerarEticket/' . $pedido->id) ?>" target="_blank" class="btn btn-primary mt-0 shadow"><i class="bx bx-printer"></i> Imprimir</a>
                            ...
                            <div class="card shadow radius-10">
                                <div class="card-body">
                                    ...
                                    <?php if ($bonus_cinemark != null) : ?>
                                        ...
                                        Código: <strong style="font-size: 16px;"><?= esc($bonus_cinemark->codigo) ?></strong><br>
                                        <hr class="mt-2">
                                    <?php endif ?>
