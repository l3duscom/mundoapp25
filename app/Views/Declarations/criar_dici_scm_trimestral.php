    ...
    <div class="col-lg-12">
        ...
        <div class="block">
            ...
            <div class="block-body">
                ...
                <?php echo $this->include('Declarations/_form_dici_scm_trimestral'); ?>


                <div class="form-group mb-2">

                    <input id="btn-salvar" type="submit" value="Gerar DICI-SCM Trimestral" class="btn btn-primary">
    ...
    $(document).ready(function() {
        ...
        $("#form").on('submit', function(e) {
            ...
            $.ajax({
                ...
                type: 'POST',
                url: '<?php echo site_url('declarations/register_dici_scm_trimestral_step_1'); ?>',
                    ...
                    if (!response.erro) {
                        ...
                        if (response.info) {
                            ...
                            window.location.href =
                                "<?php echo site_url("declarations/criar_dici_scm_trimestral_step_2/"); ?>" + response.id;
