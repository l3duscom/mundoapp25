                    ...
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu">
                            <?php if ($declaration->status == 'ABERTA') : ?>
                                <a class="dropdown-item" href="<?php echo site_url("declarations/editar_dici_scm/$declaration->id"); ?>">Editar declaração</a>
                            <?php endif; ?>
                            <a class="dropdown-item" href="<?php echo site_url("declarations/duplicar_dici_scm/$declaration->id"); ?>">Duplicar declaração</a>
                        ...
                        <tbody>
                            ...
                            <?php foreach ($declarations as $dec) : ?>
                                <tr>
                                    ...
                                    <td><?php echo esc($dec->tipo_produto); ?></td>
                                    <td><?php echo esc($dec->tipo_tecnologia); ?></td>
                                    <td><?php echo esc($dec->velocidade); ?></td>
                                    <td><?php echo esc($dec->qtd_acessos); ?></td>
                                    <td>
                                        <div class="btn-group">
                                            <?php if ($declaration->status == 'ABERTA') : ?>
                                                <a class="btn btn-sm btn-secondary" href="<?php echo site_url("declarations/editar_dici_scm_plano/$dec->id"); ?>"><i class="fas fa-edit"></i></a>
                                            <?php endif; ?>
                                            <?php
                                            $atributos = [
                                            ...
                                            ?>
                                            <?php if ($declaration->status == 'ABERTA') : ?>
                                                <?php echo form_open("/declarations/excluirPlano/$dec->id", $atributos) ?>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Adição de plano DICI-SCM</h5>
            ...
            <div class="modal-body">
                ...
                <?php echo $this->include('Declarations/_form_dici_scm_step_2'); ?>
    ...
    $(document).ready(function() {
        ...
        $("#form").on('submit', function(e) {
            ...
            $.ajax({
                ...
                type: 'POST',
                url: '<?php echo site_url('declarations/register_dici_scm_step_2'); ?>',
                    ...
                    if (!response.erro) {
                        ...
                        if (response.info) {
                            ...
                            window.location.href =
                                "<?php echo site_url("declarations/criar_dici_scm_step_2/"); ?>" + <?php echo $declaration->id; ?>;
