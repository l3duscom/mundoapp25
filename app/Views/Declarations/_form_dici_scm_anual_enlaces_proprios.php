...
<div class="row">
    ...
    <div class="form-group col-lg-3">
        ...
        <input type="text" name="enlaces_proprios_terrestres_id" class="form-control">
    </div>
    ...
    <div class="form-group col-lg-3">
        ...
        <input type="text" name="enlaces_proprios_terrestres_c_nominal" class="form-control">
    </div>
    ...
    <div class="form-group col-lg-3">
        ...
        <input type="text" name="geometria_wkt" class="form-control">
    </div>
    ...
    <div class="form-group col-lg-3">
        ...
        <input type="text" name="srid" class="form-control">
    </div>
