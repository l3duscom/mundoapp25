    ...
    <div class="col-lg-12">
        ...
        <div class="block">
            ...
            <div class="block-body">
                ...
                <?php echo $this->include('Declarations/_form_dici_tvpa'); ?>


                <div class="form-group mb-2">

                    <hr>
                    <a href="<?php echo site_url("declarations/importar/4"); ?>" class="btn btn-success"><i class="fas fa-file-import" style="padding-right: 10px;"></i> Importar</a>

                    <input id="btn-salvar" type="submit" value="Avançar" class="btn btn-primary">
    ...
    $(document).ready(function() {
        ...
        $("#form").on('submit', function(e) {
            ...
            $.ajax({
                ...
                type: 'POST',
                url: '<?php echo site_url('declarations/register_dici_tvpa_step_1'); ?>',
                    ...
                    if (!response.erro) {
                        ...
                        if (response.info) {
                            ...
                            window.location.href =
                                "<?php echo site_url("declarations/criar_dici_tvpa_step_2/"); ?>" + response.id;
