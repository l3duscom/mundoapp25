<div class="row">
    ...
    <div class="form-group col-lg-4">
        ...
        <input type="text" name="enlaces_contratados_id" class="form-control" value="<?php echo esc($plano->enlaces_contratados_id); ?>">
    </div>
    ...
    <div class="form-group col-lg-6">
        ...
        <select id="enlaces_contratados_meio" name="enlaces_contratados_meio" class="form-control">
            <option value="<?php echo esc($plano->enlaces_contratados_meio); ?>"><?php echo esc($plano->enlaces_contratados_meio); ?></option>
            <option>--</option>
    ...
    <div class="form-group col-md-6">
        ...
        <input type="text" name="enlaces_contratados_prestadora" class="form-control cnpj" value="<?php echo esc($plano->enlaces_contratados_prestadora); ?>">
    </div>
</div>