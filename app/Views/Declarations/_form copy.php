<div class="row">
    ...
    <div class="form-group col-md-12">
        ...
        <input type="text" name="nome" placeholder="Insira o nome completo" class="form-control" value="<?php echo esc($declaration->nome); ?>">
    </div>


    <div class="form-group col-md-4">
        <label class="form-control-label">CNPJ</label>
        <input type="text" name="cnpj" placeholder="Insira o CNPJ" class="form-control cnpj" value="<?php echo esc($cliente->cnpj); ?>">
    </div>
