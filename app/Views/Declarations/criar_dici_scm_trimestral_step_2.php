            ...
            <div class="row ">
                <div class="col-12">
                    ...
                    <div>
                        ...
                        <strong class="text-xl fw-normal mb-0" style="margin-top: -3px;"><?php echo esc($declaration->trimestre); ?> º trimestre de <?php echo esc($declaration->year); ?></strong>
                    ...
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu">
                            <?php if ($declaration->status == 'ABERTA') : ?>
                                <a class="dropdown-item" href="<?php echo site_url("declarations/editar/$declaration->id"); ?>">Editar declaração</a>
                            <?php endif; ?>
                            <a class="dropdown-item" href="<?php echo site_url("declarations/duplicar_dici_scm_trimestral/$declaration->id"); ?>">Duplicar declaração</a>

                            <?php if (!empty($declarations)) : ?>
                                <?php if (!usuario_logado()->is_cliente) : ?>
                                    <a class="dropdown-item" href="<?php echo site_url("declarations/gerarelatoriodiciscmtrimestral/$declaration->id"); ?>">Gerar CSV</a>
                                <?php endif; ?>
    ...
    <div class=" col-lg-9">
        <div class="block text-center">
            <?php if (empty($declarations)) : ?>
                ...
                <p class="contributions " style="margin-top: 40px;">Essa declaração ainda não possui dados</p>
                <?php if ($declaration->status == 'ABERTA') : ?>
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal"><i class="fas fa-plus" style="padding-right: 10px;"></i> Adicionar infromações</button>
                <?php endif; ?>
            <?php else : ?>
                <div class="row">
                    <div class="col-lg-4">
                        <?php if ($declaration->status == 'ABERTA') : ?>
                            <button type="button" class="btn btn-primary btn-sm btn-block" data-toggle="modal" data-target="#exampleModal"><i class="fas fa-plus" style="padding-right: 10px;"></i> Adicionar informações</button>
                        <?php endif; ?>
                    </div>
                    <div class="col-lg-4">
                    </div>
                    ...
                    <table class="table table-striped table-sm">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($declarations as $dec) : ?>
                                <tr>
                                    <td><?php echo esc($dec->DADO_INFORMADO); ?></td>
                                    <td><?php echo esc($dec->SERVICO); ?></td>
                                    <td><?php echo esc($dec->UNIDADE_DA_FEDERACAO_UF); ?></td>
                                    <td><?php echo esc($dec->VALORES); ?></td>
                                    <td>

                                        <div class="btn-group">
                                            <?php if ($declaration->status == 'ABERTA') : ?>
                                                <a class="btn btn-sm btn-secondary" href="<?php echo site_url("declarations/editar_dici_scm_trimestral_plano/$dec->id"); ?>"><i class="fas fa-edit"></i></a>
                                            <?php endif; ?>
                                            ...
                                            ?>
                                            <?php if ($declaration->status == 'ABERTA') : ?>
                                                <?php echo form_open("/declarations/excluirPlanoScmTrimestral/$dec->id", $atributos) ?>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Adição de informações DICI-SCM-TRIMESTRAL</h5>
            ...
            <div class="modal-body">
                ...
                <?php echo $this->include('Declarations/_form_dici_scm_trimestral_step_2'); ?>
    ...
    $(document).ready(function() {
        ...
        $("#form").on('submit', function(e) {
            ...
            $.ajax({
                ...
                type: 'POST',
                url: '<?php echo site_url('declarations/register_dici_scm_trimestral_step_2'); ?>',
                    ...
                    if (!response.erro) {
                        ...
                        if (response.info) {
                            ...
                            window.location.href =
                                "<?php echo site_url("declarations/criar_dici_scm_trimestral_step_2/"); ?>" + <?php echo $declaration->id; ?>;
