                    ...
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu">
                            <?php if ($declaration->status == 'ABERTA') : ?>
                                <a class="dropdown-item" href="<?php echo site_url("declarations/editar_fust/$declaration->id"); ?>">Editar declaração</a>
                            <?php endif; ?>
                            <a class="dropdown-item" href="<?php echo site_url("declarations/duplicar_fust/$declaration->id"); ?>">Duplicar declaração</a>

                            <?php if (!empty($declarations)) : ?>
                                <?php if (!usuario_logado()->is_cliente) : ?>
                                    <a class="dropdown-item" href="<?php echo site_url("declarations/gerarelatoriodiciscm/$declaration->id"); ?>">Gerar CSV</a>
                                <?php endif; ?>
                    ...
                    <table class="table table-striped table-sm">
                        ...
                        <tbody>
                            ...
                            <?php foreach ($declarations as $dec) : ?>
                                <tr>
                                    <td><?php echo esc($dec->processo); ?> </td>
                                    <td><?php echo esc($dec->referencia); ?></td>
                                    <td>R$ <?php echo esc($dec->faturamento); ?></td>
                                    <td><?php echo esc($dec->qtd_nfe); ?></td>
                                    <td><?php echo esc($dec->pis); ?></td>
                                    <td><?php echo esc($dec->cofins); ?></td>
                                    <td><?php echo esc($dec->icms); ?></td>
                                    <td>
                                        <div class="btn-group">
                                            <?php if ($declaration->status == 'ABERTA') : ?>
                                                <a class="btn btn-sm btn-secondary" href="<?php echo site_url("declarations/editar_fust_plano/$dec->id"); ?>"><i class="fas fa-edit"></i></a>
                                            <?php endif; ?>
                                            <?php
                                            $atributos = [
                                            ...
                                            ?>
                                            <?php if ($declaration->status == 'ABERTA') : ?>
                                                <?php echo form_open("/declarations/excluirPlanoFust/$dec->id", $atributos) ?>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Adição de plano FUST</h5>
            ...
            <div class="modal-body">
                ...
                <?php echo $this->include('Declarations/_form_fust_step_2'); ?>
    ...
    $(document).ready(function() {
        ...
        $("#form").on('submit', function(e) {
            ...
            $.ajax({
                ...
                type: 'POST',
                url: '<?php echo site_url('declarations/register_fust_step_2'); ?>',
                    ...
                    if (!response.erro) {
                        ...
                        if (response.info) {
                            ...
                            window.location.href =
                                "<?php echo site_url("declarations/criar_fust_step_2/"); ?>" + <?php echo $declaration->id; ?>;
