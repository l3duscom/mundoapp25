            ...
            <div class="block-body">
                ...
                <div class="card shadow radius-10">
                    <div class="card-body">
                        ...
                        <?php if ($tipo == 'epic' && $count_queue >= 1 && $day !== 'duo') : ?>
                            <div class="card shadow bg-dark radius-10">
                                <div class="card-body">
                                    <center><strong>ATENÇÃO</strong> Você já utilizou sua prioridade. Acesse a Fila Geral</center>
                                </div>
                            </div>
                        <?php elseif ($tipo == 'epic' && $count_queue >= 2 && $day === 'duo') : ?>
                            <div class="card shadow bg-dark radius-10">
                                <div class="card-body">
                                    Você já utilizou sua prioridade. Acesse a Fila Geral
                                </div>
                            </div>
                        <?php else : ?>
                                        ...
                                        <div class="card shadow bg-dark radius-10">
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col col-lg-3 col-sm-12">
                                                        <a href="<?= site_url('/console/queuecheck/' . $meet->id) ?>" class="btn btn-primary shadow w-100"><i class='bx bx-check' style="padding-right: 5px;"></i>Reservar</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
