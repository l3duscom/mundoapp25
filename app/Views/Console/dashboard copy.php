                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="flex-grow-1 ms-3 " style="padding-right: 20px;">
                            ...
                            <div class="row">
                                <div class="col-lg-9">
                                    <input id="input" type="text" class="form-control form-control-lg mb-3" style="border:none" value="<?= site_url('/evento/dreamfest_23_2?convite=' . $convite) ?>">
                            ...
                            <center>
                                ...
                                <?php if (usuario_logado()->is_influencer) : ?>
                                    <p class="mt-0" style="margin-top: -10px;">Hey influencer, você já acumulou <strong>R$ <?= number_format($indicacoes * 8, 2, '.', '') ?></strong> com indicações! <a href="" class="text-muted">Sacar</a></p>
