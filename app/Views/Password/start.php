  ...
  <div class="container-login100">
    ...
    <div class="wrap-login100">
      ...
      <div class="login100-form validate-form">
        <p class="font-20 mb-3" style="font-size: 16px; padding: 10px">
          <strong>Seu primeiro acesso? </strong><br>Informe o email que você usou na aquisição dos seus ingressos que iremos enviar um link para que você possa criar a sua senha!
        </p>
